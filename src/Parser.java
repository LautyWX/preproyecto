...
/** CUP v0.10k generated parser.
  * @version Tue Sep 17 20:20:00 ART 2024
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		Object id = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-0)).value;
            ...
            /*if (varInfo!=null) {
                System.out.println("ERROR:Variable '" + varName + "' ya ha sido declarada.")
                RESULT = null;
            } else {
		...
		Nodo b = (Nodo)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-0)).value;
            ...
            if (!a.info.tipo.equals("entero") || !b.info.tipo.equals("entero")) {
                ...
                Nodo tmp = new Nodo(new Info("\"*\"",Simbolo.STAR,null,"entero"),parser.contador);
                tmp.addHijoIzq(a);
                tmp.addHijoDer(b);
                RESULT = tmp;
            }
		...
		Nodo b = (Nodo)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-0)).value;
            ...
            if (!a.info.tipo.equals("entero") || !b.info.tipo.equals("entero")) {
                ...
                parser.texto.add("graphid:"+parser.contador+" # "+"exp + exp");
                Nodo tmp = new Nodo(new Info("\"+\"",Simbolo.PLUS,null,"entero"),parser.contador);
                tmp.addHijoIzq(a);
                tmp.addHijoDer(b);
                RESULT = tmp;
            }
