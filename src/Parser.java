...
/** CUP v0.10k generated parser.
  * @version Sat Sep 21 16:50:06 ART 2024
  */
      ...
      switch (CUP$Parser$act_num)
		...
		Nodo b = (Nodo)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-0)).value;
            ...
            if (!a.info.tipo.equals("entero") || !b.info.tipo.equals("entero")) {
                ...
                Nodo tmp = new Nodo(new Info("\"*\"",Simbolo.STAR,resultadoProducto,"entero"),parser.contador);
                tmp.addHijoIzq(a);
                tmp.addHijoDer(b);
                RESULT = tmp;
            }
		...
		Nodo b = (Nodo)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-0)).value;
            ...
            if (!a.info.tipo.equals("entero") || !b.info.tipo.equals("entero")) {
                ...
                parser.texto.add("graphid:"+parser.contador+" # "+"exp + exp");
                Nodo tmp = new Nodo(new Info("\"+\"",Simbolo.PLUS,resultadoSuma,"entero"),parser.contador);
                tmp.addHijoIzq(a);
                tmp.addHijoDer(b);
                RESULT = tmp;
            }
		...
		Nodo v = (Nodo)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
            ...
            if (parser.symbolTable.lookup(varName) != null) {
                ...
                parser.symbolTable.addSymbol(varName, parser.contador, null, t.info.tipo);
                Nodo tmp = new Nodo(new Info("declaracion",null,0,null),parser.contador); //test, todos los valores seran inicializados en 0
                tmp.addHijoIzq(t);
                tmp.addHijoDer(v);
                RESULT = tmp;
            }
